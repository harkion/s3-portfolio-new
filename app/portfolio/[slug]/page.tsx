...
// app/portfolio/[slug]/page.tsx --> Dynamic Project Page, based on slug
...
const projects: Record<string, ProjectData> = {
  ...
  belco: {
    ...
    galleryImages: ["/project-belco-1.jpg", "/project-belco-2.jpg"],
    overview:
  ...
  osfast: {
    ...
    galleryImages: ["/project-osfast-1.jpg", "/project-osfast-2.jpg"],
    overview:
  ...
  "gaha-geek": {
    ...
    galleryImages: ["/project-gaha-1.jpg", "/project-gaha-2.jpg"],
    overview:
  ...
  "zone-in": {
    ...
    galleryImages: ["/project-zonein-1.jpg", "/project-zonein-2.jpg"],
    overview:
      "Zone In is a web-based reaction game I created to explore how interactive media can be used in a focused, creative way. Built using HTML, CSS, and JavaScript, the game was a chance for me to combine technical coding skills with user-centered design. The game is designed especially for people with ADHD, focusing on training focus and reflexes in a minimal, clear, and fun way.",
    challenge:
      "Initially, I wasn't sure what direction to take for Project X. The challenge was to create a focus-based game that would be ADHD friendly, avoiding overstimulation while keeping it engaging. I needed to understand how to design for attention and accessibility.",
    solution:
...
export default async function ProjectPage({
  ...
  return (
    <div className={styles.container}>
      ...
      <div className="relative w-full aspect-video bg-gray-800 rounded-2xl overflow-hidden mb-24">
        {project.heroImage && (
          <Image
      ...
      <footer className={styles.footerNav}>
        ...
        {nav.next ? (
          <Link
            ...
            className={`${styles.navLink} text-right items-end`}
          >
            <span className={styles.navLabel}>
